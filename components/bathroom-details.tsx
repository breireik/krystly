...
export default function BathroomDetails({ property }: BathroomDetailsProps) {
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-xl font-semibold mb-4">Bathroom Features</h3>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li className="flex justify-between py-2 border-b">
              ...
              <span className="font-medium">{property.bathroomSize} sq ft</span>
            </li>
            <li className="flex justify-between py-2 border-b">
